...
import { listCategory, getCategory, delCategory, addCategory, updateCategory } from "@/api/blog/category.js";
...
function handleDelete(row) {
  ...
  proxy.$modal.confirm('是否确认删除文章分类管理编号为"' + _ids + '"的数据项？').then(function() {
